...
private typealias LoadConstraintsArgumentTuple = (primaryConstraints: [NSLayoutConstraint], primaryTag: Int, secondaryConstraints: [NSLayoutConstraint], secondaryTag: Int)

private typealias ActivateConstraintWithTagArgumentTuple = (tag: Int, animated: Bool, completion: ConstraintSwitcherCompletedClosure?)
...
class ResizingSwitcherTests: XCTestCase {
    ...
    fileprivate func areCorrectConstraintsLoaded(_ argumentTuple: LoadConstraintsArgumentTuple) -> Bool {
        ...
        return isCorrectExpandedConstraints && isCorrectExpandedTag && isCorrectContractedConstraints && isCorrectContractedTag
    }
...
private final class TestConstraintSwitcher: ConstraintSwitcher {
    ...
    func loadConstraints(primaryConstraints: [NSLayoutConstraint],
                                            ...
                                            secondaryTag: Int) {
        self.loadConstraintsClosure?(primaryConstraints: primaryConstraints, primaryTag: primaryTag, secondaryConstraints: secondaryConstraints,
